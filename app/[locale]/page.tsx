...
const translations = {
  de: {
    ...
    heroTitle:
      "Entdecke Deutschlands schönste Aussichtspunkte,<br /> perfekt für dich <br />und deinen Hund",
    heroDesc:
      "Über 320 Aussichtspunkte in 16 Bundesländern mit <br />Informationen zu Hundepensionen in der Nähe.",
    ...
    footerAboutDesc:
      "Entdecke die schönsten Aussichtspunkte in Deutschland und finde zuverlässige Hundepensionen in deiner Nähe.",
    footerLinks: "Links",
  ...
  en: {
    ...
    heroTitle:
      "Discover Germany's most beautiful viewpoints,<br /> perfect for you<br /> and your dog",
    heroDesc:
      "Over 320 viewpoints in 16 federal states with <br />information about dog kennels nearby.",
    ...
    footerAboutDesc:
      "Discover the most beautiful viewpoints in Germany and find reliable dog kennels near you.",
    footerLinks: "Links",
    ...
    <div className="min-h-screen bg-gradient-to-b from-background to-muted flex flex-col">
      ...
      <main className="flex-grow">
        ...
        <section className="relative w-full h-[320px] sm:h-[420px] lg:h-[720px] overflow-hidden">
          ...
          <div
            className="relative z-10 max-w-7xl mx-auto h-full px-4 sm:px-6 lg:px-8 
        ...
        <section className="max-w-7xl mx-auto px-4 py-12 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
            {filteredStates.map((state) => (
              <Link
                key={state.name}
                href={`/${locale}/bundesland/${state.name}`}
              >
        ...
        <section className="max-w-7xl mx-auto px-4 py-12 sm:px-6 lg:px-8">
          <Card>
            <CardHeader>
              <CardTitle className="text-2xl">{t.mapTitle}</CardTitle>
              <p className="text-muted-foreground">
                {t.mapDesc} {Object.values(viewpointsByState).flat().length}{" "}
                {t.mapDesc2}
              </p>
            </CardHeader>
            <CardContent>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            ...
            <div className="space-y-3">
              ...
              <ul className="space-y-2 text-sm">
                ...
                <li>
                  <Link
                    href={`/${locale}/bundesland/Baden-Württemberg`}
                    className="text-muted-foreground hover:text-primary transition-colors"
                  >
            ...
            <div className="space-y-3">
              ...
              <ul className="space-y-2 text-sm">
                <li className="flex items-center gap-2 text-muted-foreground">
                  ...
                  <a
                    href="mailto:info@happydogsights.de"
